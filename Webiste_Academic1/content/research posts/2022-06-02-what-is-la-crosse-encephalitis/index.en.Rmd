...
In the grand scheme of things, LACV disease is rare. For the entire United States, fewer than 100 cases of LACV disease are diagnosed each year, but that statistic misses the bigger (or smaller?) picture: a small group of people bear the burden of LACV diseases. LACV infection risk depends heavily on where one lives, and almost every case of LACV disease is associated with a few high-risk areas in either Appalachia or the upper Midwest. Consistently, LACV disease occurs in the same regions in a select number of counties. The highest risks by-far are for children living in western North Carolina, east Tennessee, West Virginia, and Ohio. In 2018, researchers in North Carolina realized that not only does LACV disease consistently occur in the same counties, but it also occurs at the _same households_. In some cases, this meant that multiple children living at one house became sick during the same year. Surprisingly, they also found that people were also becoming sick at the same household _in different years_. The most extreme example of this was two cases of LACV disease that occurred 7 years apart, with ownership of the home being transferred during that 7-year period [@byrdSpatiallyAssociatedCoincident2018]. Additionally, LACV disease is thought to be heavily under reported; cases of lesser severity are unlikely to be diagnosed, and the cases that we do see are just the "tip of the iceberg" in the high-risk areas. 
